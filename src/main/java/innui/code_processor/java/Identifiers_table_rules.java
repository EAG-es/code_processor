...
public class Identifiers_table_rules extends innui.code_processor.Identifiers_table_rules {
    ...
    public Analizer_rules.@Nullable Rules_and_rule_nodes _define_rule_package(Oks ok, Object ... extras_array) throws Exception {
        ...
        try {
            Analizer_rules.Rules_and_rule_nodes r_define_rule_package_rule_node = new Analizer_rules.Rules_and_rule_nodes(analizer_rules);
            ...
            r_define_rule_package_rule_node.defined_rule_nodes_and_list.add(t_package_rule_node);
            r_define_rule_package_rule_node.defined_rule_nodes_and_list.add(t_identifier_rule_node);
            r_define_rule_package_rule_node.defined_rule_nodes_and_list.add(r_dot_identifier_rule_node);
            r_define_rule_package_rule_node.defined_rule_nodes_and_list.add(t_semi_colon_rule_node);
    ...
    public Analizer_rules.@Nullable Rule_nodes _define_rule_class_method_and_attribute(Oks ok, Object ... extras_array) throws Exception {
        ...
        try {
            Analizer_rules.Rules_and_rule_nodes r_define_rule_class_method_and_attribute_rule_node = new Analizer_rules.Rules_and_rule_nodes(analizer_rules);
            ...
            r_define_rule_class_method_and_attribute_rule_node.defined_rule_nodes_and_list.add(r_class_rule_node);
            r_define_rule_class_method_and_attribute_rule_node.defined_rule_nodes_and_list.add(ok.valid(_define_rule_method_or_attribute_or_class(ok, extras_array)));
    ...
    public Analizer_rules.@Nullable Rule_nodes _define_rule_method_or_attribute_or_class(Oks ok, Object ... extras_array) throws Exception {
        ...
        try {
            ...
            Analizer_rules.Tokens_or_rule_nodes t_identifier_rule_node = new Analizer_rules.Tokens_or_rule_nodes(analizer_rules);
            Analizer_rules.Rules_or_rule_nodes o_parenthesis_open_or_semicolon_rule_node = new Analizer_rules.Rules_or_rule_nodes(analizer_rules);
            Analizer_rules.Rules_and_rule_nodes r_parenthesis_rule_node = new Analizer_rules.Rules_and_rule_nodes(analizer_rules);
            Analizer_rules.Tokens_or_rule_nodes t_parenthesis_open_rule_node = new Analizer_rules.Tokens_or_rule_nodes(analizer_rules);
            Analizer_rules.Tokens_or_rule_nodes t_parenthesis_close_rule_node = new Analizer_rules.Tokens_or_rule_nodes(analizer_rules);
            Analizer_rules.Tokens_or_rule_nodes t_semicolon_rule_node = new Analizer_rules.Tokens_or_rule_nodes(analizer_rules);
            ...
            Analizer_rules.Tokens_or_rule_nodes t_annotation_parenthesis_open_rule_node = new Analizer_rules.Tokens_or_rule_nodes(analizer_rules);
            Analizer_rules.Tokens_or_rule_nodes t_annotation_parenthesis_close_rule_node = new Analizer_rules.Tokens_or_rule_nodes(analizer_rules);
            Analizer_rules.Tokens_or_rule_nodes t_annotation_parenthesis_close_1_rule_node = new Analizer_rules.Tokens_or_rule_nodes(analizer_rules);
            ...
            r_method_or_attribute_rule_node.defined_name = "r_method_or_attribute_rule_node: " +
                    "r_template<optional> t_identifier_type t_identifier o_parenthesis_open_or_semicolon";
            ...
            r_annotation_begin_end_rule_node.defined_rule_nodes_and_list.add(t_annotation_parenthesis_open_rule_node);
            r_annotation_begin_end_rule_node.defined_rule_nodes_and_list.add(t_annotation_parenthesis_close_rule_node);
            r_annotation_begin_end_rule_node.defined_rule_nodes_and_list.add(t_annotation_parenthesis_close_1_rule_node);
            ...
            t_annotation_parenthesis_open_rule_node.defined_tokens_or_list.add(new Scanner_rules.Basic_tokens(parenthesis_open.name()));
            /* "t_annotation_parenthesis_close<ignore>: parenthesis_close" */
            t_annotation_parenthesis_close_rule_node.defined_tokens_or_list.add(new Scanner_rules.Basic_tokens(parenthesis_close.name()));
            ...
            t_annotation_parenthesis_close_1_rule_node.defined_tokens_or_list.add(new Scanner_rules.Basic_tokens(parenthesis_close.name()));
            ...
            r_method_or_attribute_rule_node.defined_rule_nodes_and_list.add(o_parenthesis_open_or_semicolon_rule_node);
            ...
            o_parenthesis_open_or_semicolon_rule_node.defined_rule_nodes_or_list.add(r_parenthesis_rule_node);
            o_parenthesis_open_or_semicolon_rule_node.defined_rule_nodes_or_list.add(t_semicolon_rule_node);
            ...
            r_parenthesis_rule_node.defined_rule_nodes_and_list.add(t_parenthesis_open_rule_node);
            r_parenthesis_rule_node.defined_rule_nodes_and_list.add(t_parenthesis_close_rule_node);
            /* "t_parenthesis_open: parenthesis_open" */
            t_parenthesis_open_rule_node.defined_tokens_or_list.add(new Scanner_rules.Basic_tokens(parenthesis_open.name()));
            /* "t_parenthesis_close<ignore>: parenthesis_close" */
            t_parenthesis_close_rule_node.defined_tokens_or_list.add(new Scanner_rules.Basic_tokens(parenthesis_close.name()));
            ...
            t_semicolon_rule_node.defined_tokens_or_list.add(new Scanner_rules.Basic_tokens(semi_colon.name()));
